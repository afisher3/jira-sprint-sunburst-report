...
describe('SunburstAggregator', () => {
  it('should aggregate issues by classification and sum story points', () => {
    const issues: Issue[] = [
      ...
      { key: 'PROJ-4', summary: 'Task 4', storyPoints: 4, classification: { level1: 'Infrastructure', level2: 'Maintenance' }, qaFailCount: 0 }
    ];
  ...
  it('should create correct parent-child relationships', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'Task', storyPoints: 5, classification: { level1: 'Security', level2: 'Audit' }, qaFailCount: 0 }
    ];
  ...
  it('should handle issues with zero story points', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'Task 1', storyPoints: 0, classification: { level1: 'App Dev', level2: 'New Feature' }, qaFailCount: 0 },
      { key: 'PROJ-2', summary: 'Task 2', storyPoints: 5, classification: { level1: 'App Dev', level2: 'New Feature' }, qaFailCount: 0 }
    ];
  ...
  it('should handle unclassified issues', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'Task', storyPoints: 3, classification: { level1: 'Unclassified', level2: 'Unspecified' }, qaFailCount: 0 }
    ];
  ...
  it('should aggregate multiple issues with same classification', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'Task 1', storyPoints: 2, classification: { level1: 'Test', level2: 'Unit Test' }, qaFailCount: 0 },
      { key: 'PROJ-2', summary: 'Task 2', storyPoints: 3, classification: { level1: 'Test', level2: 'Unit Test' }, qaFailCount: 0 },
      { key: 'PROJ-3', summary: 'Task 3', storyPoints: 1, classification: { level1: 'Test', level2: 'Unit Test' }, qaFailCount: 0 }
    ];
  ...
  it('should use correct labels (level2 name, not full path)', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'Task', storyPoints: 5, classification: { level1: 'App Dev', level2: 'New Feature' }, qaFailCount: 0 }
    ];
  ...
  it('should handle multiple level1 categories with subcategories', () => {
    const issues: Issue[] = [
      { key: 'PROJ-1', summary: 'T1', storyPoints: 5, classification: { level1: 'A', level2: 'A1' }, qaFailCount: 0 },
      { key: 'PROJ-2', summary: 'T2', storyPoints: 3, classification: { level1: 'A', level2: 'A2' }, qaFailCount: 0 },
      { key: 'PROJ-3', summary: 'T3', storyPoints: 2, classification: { level1: 'B', level2: 'B1' }, qaFailCount: 0 },
      { key: 'PROJ-4', summary: 'T4', storyPoints: 4, classification: { level1: 'B', level2: 'B2' }, qaFailCount: 0 },
      { key: 'PROJ-5', summary: 'T5', storyPoints: 1, classification: { level1: 'C', level2: 'C1' }, qaFailCount: 0 }
    ];
