...
export const JiraConfigSchema = z.object({
  ...
  readyForTestingStatusName: z.string().min(1, 'readyForTestingStatusName must not be empty'),
  readyForUatStatusName: z.string().min(1, 'readyForUatStatusName must not be empty'),
